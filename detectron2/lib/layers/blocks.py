...
from detectron2.lib.utils.net import make_divisible
from detectron2.lib.layers.wrappers import get_conv_op, get_norm_op, make_conv, make_norm, make_act, make_ctx
...
class BlockBase(nn.Module):
    ...
    def freeze(self):
        ...
        ops.FrozenBatchNorm2d.convert_frozen_batchnorm(self)
        return self
