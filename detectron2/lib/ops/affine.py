...
from detectron2.lib.utils.comm import get_world_size
...
class AffineChannel2d(nn.Module):
    ...
    def forward(self, x):
        return x * self.weight.view(1, self.num_channels, 1, 1) + self.bias.view(1, self.num_channels, 1, 1)

    def __repr__(self):
        return "AffineChannel2d(num_features={}, eps={})".format(self.num_channels, self.eps)
